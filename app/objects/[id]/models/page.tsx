...
import BimModelsList from '@/components/BimModelsList';
import ObjectDetailTabs from '@/components/ObjectDetailTabs';

export default async function ObjectModelsPage({
  params,
}: {
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-6xl mx-auto">
          <div className="mb-6">
            ...
            <div>
              <h1 className="text-2xl md:text-4xl font-bold mb-2">3D Модели</h1>
